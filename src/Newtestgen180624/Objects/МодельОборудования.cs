...
namespace DataLine.Newtestgen180624
{
    ...
    public class МодельОборудования : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.Newtestgen180624.Организация fПроизводитель;
        
        private DataLine.Newtestgen180624.DetailArrayOfДокументКМодели fДокументы;
        ...
        public virtual DataLine.Newtestgen180624.Организация Производитель
        {
            get
            {
                ...
                DataLine.Newtestgen180624.Организация result = this.fПроизводитель;
        ...
        public virtual DataLine.Newtestgen180624.DetailArrayOfДокументКМодели Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new DataLine.Newtestgen180624.DetailArrayOfДокументКМодели(this);
                }
                DataLine.Newtestgen180624.DetailArrayOfДокументКМодели result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МодельОборудованияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МодельОборудованияE", typeof(DataLine.Newtestgen180624.МодельОборудования));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МодельОборудованияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МодельОборудованияL", typeof(DataLine.Newtestgen180624.МодельОборудования));
                }
            }
        }
    }

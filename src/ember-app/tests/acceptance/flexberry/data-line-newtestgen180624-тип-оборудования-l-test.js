...
moduleForAcceptance('[AGAT] Acceptance | data line newtestgen180624 тип оборудования l');

test('testing data-line-newtestgen180624-тип-оборудования-l', function(assert) {

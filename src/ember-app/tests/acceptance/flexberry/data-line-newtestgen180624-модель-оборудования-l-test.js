...
moduleForAcceptance('[AGAT] Acceptance | data line newtestgen180624 модель оборудования l');

test('testing data-line-newtestgen180624-модель-оборудования-l', function(assert) {
